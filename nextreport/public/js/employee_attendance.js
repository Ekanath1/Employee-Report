frappe.provide("nextreport.employee_attendance");

nextreport.employee_attendance= {
	"filters": get_filters(),
	"formatter": function(value, row, column, data, default_formatter) {
		if (data && column.fieldname=="employee") {
			value = data.employee_name || value;

			column.link_onclick =
				"nextreport.employee_attendance.open_employee(" + JSON.stringify(data) + ")";
			column.is_tree = true;
		}
		...
		console.log("111111111111111111111111111111111111111111111",value)
		return value;
	},
